...
{
	public class LineLayoutForTimeLineSlider : UICollectionViewFlowLayout
	{
		public const float ITEM_HEIGHT = 115f;
		public const float ITEM_WIDTH = 75f;
		public const int ACTIVE_DISTANCE = 0;
		public const float ZOOM_FACTOR = 0f;

		public LineLayoutForTimeLineSlider()
		{
			...
			SectionInset = new UIEdgeInsets(0f, 0f, 0f, 0f);
