...
namespace Bisner.Mobile.iOS.Controls.SlidingPanels
{
    ...
    public class SlidingPanelsNavigationViewController : UINavigationController
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="SlidingPanels.SlidingPanelsNavigationViewController" /> class.
        /// </summary>
        ...
        {
            var container = _panelContainers.FirstOrDefault(p => p.PanelType == type);
            //if (container == null)
            //{
        ...
        {
            var container = ExistingContainerForType(type);
            if (container == null)
            {
                return;
            }
