...
{
    public class MyImagePickerTask
        : MvxIosTask
          , IMvxBisnerImageTask
    {
        ...
        public MyImagePickerTask()
        {
            ...
            _picker.NavigationBar.Translucent = false;
            _picker.NavigationBar.TintColor = UIColor.Blue;
            _picker.EdgesForExtendedLayout = UIRectEdge.None;
        ...
        public void ChangeDevice(bool front)
        {
            _picker.SourceType = UIImagePickerControllerSourceType.Camera;
            _picker.CameraDevice = front ? UIImagePickerControllerCameraDevice.Front : UIImagePickerControllerCameraDevice.Rear;
        }
